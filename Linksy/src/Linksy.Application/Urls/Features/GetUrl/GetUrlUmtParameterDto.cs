...
namespace Linksy.Application.Urls.Features.GetUrl
{
    public record class GetUrlUmtParameterDto
    {
        ...
        public GetUrlUmtParameterDto(int id, string? umtSource, string? umtMedium, string? umtCampaign, int? qrCodeId, int? qrCodeScanCount, DateTime createdAt, DateTime? updatedAt)
        {
            Id = id;
            UmtSource = umtSource;
            UmtMedium = umtMedium;
