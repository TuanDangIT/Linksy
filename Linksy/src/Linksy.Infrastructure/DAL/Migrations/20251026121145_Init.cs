        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackgroundColor = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LandingPages_Urls_UrlId",
                        column: x => x.UrlId,
                        principalTable: "Urls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LandingPageItems_QrCodes_QrCodeId",
                        column: x => x.QrCodeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LandingPageItems_QrCodeId",
                table: "LandingPageItems",
                column: "QrCodeId");
