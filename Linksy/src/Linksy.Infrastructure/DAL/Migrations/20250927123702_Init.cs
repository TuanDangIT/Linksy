        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_LandingPage_VisitCount", "\"VisitCount\" >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LandingPageItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LandingPageItem_LandingPage_LandingPageId",
                        column: x => x.LandingPageId,
                        principalTable: "LandingPage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LandingPageItem_Url_UrlId",
                        column: x => x.UrlId,
                        principalTable: "Url",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsUmtOn = table.Column<bool>(type: "boolean", nullable: true),
                    UserId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScanCode", x => x.Id);
                    table.CheckConstraint("CK_ScanCode_ScanCount", "\"ScanCount\" >= 0");
                    table.ForeignKey(
                        name: "FK_ScanCode_Url_UrlId",
                        column: x => x.UrlId,
                        principalTable: "Url",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QrCodePage", x => x.Id);
                    table.CheckConstraint("CK_QrCodePage_VisitCount", "\"VisitCount\" >= 0");
                    table.ForeignKey(
                        name: "FK_QrCodePage_ScanCode_QrCodeId",
                        column: x => x.QrCodeId,
                        principalTable: "ScanCode",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UmtParameter_ScanCode_QrCodeId",
                        column: x => x.QrCodeId,
                        principalTable: "ScanCode",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LandingPageItem_LandingPageId",
                table: "LandingPageItem",
                column: "LandingPageId");

            migrationBuilder.CreateIndex(
                name: "IX_LandingPageItem_UrlId",
                table: "LandingPageItem",
                column: "UrlId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QrCodePage_QrCodeId",
                table: "QrCodePage",
                column: "QrCodeId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ScanCode_UrlId",
                table: "ScanCode",
                column: "UrlId",
                unique: true);
